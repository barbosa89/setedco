...
@section('content')
        ...
        <div class="da-home-page-text" data-aos="fade-right" data-aos-duration="1000">
            <div class="container">
                <div class="col-md-10 col-sm-12 px-0 mx-0">
                    <h2 class="display-3 titles first-title" style="color: rgba(63, 63, 63, 1);">Ingeniería integral</h2>
                    <h3 class="h5 mt-3 titles" style="color: rgba(63, 63, 63, 1);">Soluciones eléctricas y tecnológicas para la empresa y el hogar</h3>
    ...
    <div class="page-content">
        <div>
            ...
            <div class="da-contact" id="contact" data-background="{{ asset('theme/images/staticmap.png') }}">
